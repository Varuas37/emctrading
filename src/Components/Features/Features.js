...
function Features() {
	...
	return (
		<section id="features" className="bg-primarybg text-white pt-7">
			<h1
				className="flex flex-col font-bold text-3xl ml-10 sm:p-0 sm:text-5xl text m-2 flex-wrap"
				style={{ fontFamily: 'Gilroy-ExtraBold' }}
			>
				Features
			</h1>
			<div className="flex justify-center items-center w-full">
				<div className="w-4/5 mt-5 sm:m-0 sm:mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
