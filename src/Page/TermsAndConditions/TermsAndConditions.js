				...
				<div className="container">
					<div className="row">
						<div className="col-md-12">
							...
							<p className="mt-10">Welcome to Stoff Capital!</p>
							<p>
								These terms and conditions outline the rules and regulations for the use of Stoff
								Capital's Website, located at stoff.capital.
							</p>
							<p>
								By accessing this website we assume you accept these terms and conditions. Do not
								continue to use Stoff Capital if you do not agree to take all of the terms and
							...
							<p>
								We employ the use of cookies. By accessing Stoff Capital, you agreed to use cookies in
								agreement with the Stoff Capital's Privacy Policy.{' '}
							</p>
							<p>
							...
							<p>
								Unless otherwise stated, Stoff Capital and/or its licensors own the intellectual
								property rights for all material on Stoff Capital. All intellectual property rights are
								reserved. You may access this from Stoff Capital for your own personal use subjected to
								restrictions set in these terms and conditions.
							</p>
							<p>You must not:</p>
							<ul>
								<li>Republish material from Stoff Capital</li>
								<li>Sell, rent or sub-license material from Stoff Capital</li>
								<li>Reproduce, duplicate or copy material from Stoff Capital</li>
								<li>Redistribute content from Stoff Capital</li>
							</ul>
							<p>
								...
								and the <a href="https://www.generateprivacypolicy.com">Privacy Policy Generator</a>.
							</p>
							<p>
								Parts of this website offer an opportunity for users to post and exchange opinions and
								information in certain areas of the website. Stoff Capital does not filter, edit,
								publish or review Comments prior to their presence on the website. Comments do not
								reflect the views and opinions of Stoff Capital,its agents and/or affiliates. Comments
								reflect the views and opinions of the person who post their views and opinions. To the
								extent permitted by applicable laws, Stoff Capital shall not be liable for the Comments
							...
							<p>
								Stoff Capital reserves the right to monitor all Comments and to remove any Comments
							...
							<p>
								You hereby grant Stoff Capital a non-exclusive license to use, reproduce, edit and
							...
							<p>
								...
								visibility of the hyperlink compensates the absence of Stoff Capital; and (d) the link
							...
							<p>
								...
								linking to our website, you must inform us by sending an e-mail to Stoff Capital. Please
							...
							<p>
								No use of Stoff Capital's logo or other artwork will be allowed for linking absent a
...
data-cf-beacon='{"version":"2021.1.2","si":10,"r":1,"rayId":"61b0d83908f1fef6"}'
></script> */}